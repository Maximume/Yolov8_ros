...
STOP_OBJECT_LIST = ['person', 'bicycle', 'car', 'motorcycle', 'airplane', 'bus', 'train', 'truck', 'boat', 'traffic light', 
...
class Yolo_Dect:
    ...
    def image_callback(self, image):
        ...
        if self.is_obstacle:
            ...
            results = self.model(self.color_image, show=False, conf=self.model.conf, verbose=False)
